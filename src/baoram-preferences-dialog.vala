...
namespace Baoram {
    ...
    [GtkTemplate (ui = "/freynaldo/baoram/ui/baoram-excluded-row.ui")]
    ...
    [GtkTemplate (ui = "/freynaldo/baoram/ui/baoram-preferences-dialog.ui")]
    public class PreferencesDialog : Adw.PreferencesDialog {
        ...
        construct {
            prefs_settings = new Settings ("freynaldo.baoram.preferences");
