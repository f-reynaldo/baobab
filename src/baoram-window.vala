...
namespace Baoram {
    ...
    [GtkTemplate (ui = "/freynaldo/baoram/ui/baoram-main-window.ui")]
    public class Window : Adw.ApplicationWindow {
        ...
        public Window (Application app) {
            ...
            var ui_settings = new Settings ("freynaldo.baoram.ui");
            ui_settings.delay ();
            ...
            var builder = new Gtk.Builder.from_resource("/freynaldo/baoram/ui/baoram-treeview-menu.ui");
        ...
        void on_help_activate () {
            Gtk.show_uri (this, "help:baoram", Gdk.CURRENT_TIME);
        }
        ...
        void on_about_activate () {
            ...
            var about = new Adw.AboutDialog() {
                ...
                application_icon = "freynaldo.baoram",
                developer_name = _("The GNOME Project"),
                version = Config.VERSION,
                website = "https://apps.gnome.org/Baoram/",
                issue_url = "https://gitlab.gnome.org/GNOME/baoram/-/issues/new",
                copyright = copyright,
