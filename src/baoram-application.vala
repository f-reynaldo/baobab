...
namespace Baoram {
    ...
    public class Application : Adw.Application {
        ...
        public GenericSet<string> get_excluded_locations () {
            ...
            var prefs_settings = new Settings ("freynaldo.baoram.preferences");
        ...
        public Application () {
            Object (application_id: "freynaldo.baoram", flags: ApplicationFlags.HANDLES_OPEN);

            set_resource_base_path("/freynaldo/baoram/");
