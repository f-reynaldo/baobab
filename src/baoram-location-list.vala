...
namespace Baoram {
    ...
    [GtkTemplate (ui = "/freynaldo/baoram/ui/baoram-location-row.ui")]
    ...
    [GtkTemplate (ui = "/freynaldo/baoram/ui/baoram-location-list.ui")]
    public class LocationList : Adw.PreferencesPage {
        ...
        void populate_recent () {
            ...
            while (iter != null) {
                ...
                if (!iter.data.has_group ("baoram") || !iter.data.exists () || already_present (File.new_for_uri (iter.data.get_uri ()))) {
